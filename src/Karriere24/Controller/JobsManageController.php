...
namespace Karriere24\Controller;
...
class JobsManageController extends ManageController
{
    ...
    public function preDispatch(MvcEvent $e)
    {
        ...
        if ('approval' == $action) {
            ...
            $mailSender = $services->get('Karriere24/Listener/DelayedUserRegistrationMailSender');
    ...
    protected function save($parameter = array())
    {
        ...
        $session = new SessionContainer('Karriere24_Jobs_Manage');
    ...
    protected function getFormular($job)
    {
        ...
        if ($this->auth()->getUser() instanceof AnonymousUser) {
            $container->setForm(
                'regForm',
                array(
                'type' => 'Karriere24/IncludedRegisterForm',
                'options' => array(
                    'label' => 'Unternehmen',
